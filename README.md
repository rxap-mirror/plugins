...
--- | --- | --- | --- | ---
@rxap/plugin-build-info | GPL-3.0 | - | - | 
@rxap/plugin-i18n | GPL-3.0 | - | - | 
@rxap/plugin-kaniko | GPL-3.0 | - | - | 
@rxap/plugin-library | GPL-3.0 | - | - | A Nx/Ng plugin for build many library types.
@rxap/plugin-library-publish | GPL-3.0 | - | - | 
@rxap/plugin-library-schematics | GPL-3.0 | - | - | A builder to compile angular library schematics.
@rxap/plugin-localazy | GPL-3.0 | - | - | A Nx/Ng plugin for localazy.com upload and download tasks.
