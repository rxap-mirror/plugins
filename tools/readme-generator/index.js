...
for (const [project, path] of Object.entries(angularJson.projects)) {
  if (typeof path === 'string') {
    angularJson.projects[project] = require('../../' + path + '/project.json');
    angularJson.projects[project].root = path;
  }
}
